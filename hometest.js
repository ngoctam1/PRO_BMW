...
{/* accessories */}
        <View style={styles.cardContainer}>
          <View style={styles.card}>
                ...
                <Text style={styles.heading}>POPULAR WITH DRIVERS</Text>
                <Text style={styles.subtitle}>Trending options for your BMW</Text>
                <TouchableOpacity>
                  <Text style={styles.browseLink}>Browse All &rarr;</Text>
                </TouchableOpacity>
              </View>
          </View>
...
iconPlaceholder: {
  fontSize: 50, // Make this large to simulate an icon
  marginBottom: 10,
},
optionTitle: {
  fontSize: 16,
